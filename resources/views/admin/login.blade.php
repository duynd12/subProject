...
<body class="align">
    ...
    <div class="grid">
        ...
        <form action="{{route('admin.authenticate')}}" method="POST" class="form login">
            @csrf
        ...
        <p class="text--center">Not a member? <a href="{{route('admin.create')}}">Sign up now</a> <svg class="icon">
